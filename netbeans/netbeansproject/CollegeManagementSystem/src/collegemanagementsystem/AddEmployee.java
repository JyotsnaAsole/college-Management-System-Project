...
public void connect(){
    ...
    private void initComponents() {
        ...
        jLabel2.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 2, true));
        ...
        jLabel6.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(153, 153, 153), 2, true));
        ...
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/employee.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 924, Short.MAX_VALUE)
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String positionofe=jTextField3.getText();
        ...
        try{
            String sql="insert into employee(firstname,lastname,positionofe,contact,emailid,gender,permanantaddress,currentaddress)values('"+firstname+"','"+lastname+"','"+positionofe+"','"+contact+"','"+emailid+"','"+gender+"','"+permanantaddress+"','"+currentaddress+"')";
