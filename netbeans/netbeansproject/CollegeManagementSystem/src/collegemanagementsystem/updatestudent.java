...
public class updatestudent extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(rs.next() == true)
            {
                ...
                jTextField4.setText(rs.getString("classofs"));
                jComboBox1.setSelectedItem(rs.getString("yearofs"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String classofs= jTextField4.getText();
        String yearofs = (String) jComboBox1.getSelectedItem();
        ...
        try
        {
         String sql = " update student set firstname = '"+firstname+"', lastname='"+lastname+"',emailid = '"+emailid+"',gender ='"+gender+"',classofs='"+classofs+"',yearofs='"+yearofs+"',contact='"+contact+"',dateofbirth='"+dateofbirth+"',permanantaddress='"+permanantaddress+"',currentaddress='"+currentaddress+"' where id = '"+id+"' ";
