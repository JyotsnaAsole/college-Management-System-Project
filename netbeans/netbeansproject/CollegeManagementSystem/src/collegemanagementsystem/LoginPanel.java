...
public class LoginPanel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/clgmngsys.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
        String sql="select * from logintable where adminname = '"+username+"' and password = '"+password+"'  ";
        rs=St.executeQuery(sql);
        if(rs.next())
       {
              JOptionPane.showConfirmDialog(this, "login successful", "message", JOptionPane.INFORMATION_MESSAGE );
              this.setVisible(false);
             new AdminPanel().show();
            
        }
        else{ 
            JOptionPane.showConfirmDialog(this, "username or password is incorrect", "error", JOptionPane.ERROR_MESSAGE);
